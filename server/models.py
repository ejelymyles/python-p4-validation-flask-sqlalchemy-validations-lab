...
class Post(db.Model):
    ...
    def validate_category(self, key, category):
        if category not in ['Fiction', 'Non-Fiction']:
            raise ValueError("Post category mus be either 'Fiction' or 'Non-Fiction'. ")
        return category
    ...
    def validate_title(self, key, title):
        ...
        if not any(phrase in title for phrase in clickbait_phrases):
            raise ValueError("Post title mist contain one of the following phrases: 'Won't Beleieve', 'Secret', 'Top', 'Guess'.")
        return title 
